...
int main(int argc, char *argv[]) {
	...
	/*
	Loop through the matrix and start finding the mininum path going up and to the left, starting at 79, 79. The first set of loops puts the sums of each number in the location of the matrix.
